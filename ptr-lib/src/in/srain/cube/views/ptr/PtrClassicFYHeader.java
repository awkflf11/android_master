...
/**
 * Created by dubin on 16/4/7.
 */
public class PtrClassicFYHeader extends FrameLayout implements PtrUIHandler {
    ...
    public PtrClassicFYHeader(Context context) {
        super(context);
        initViews(null);
    }

    public PtrClassicFYHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public PtrClassicFYHeader(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        ...
        //hideRotateView();
        mRotateView.setImageResource(R.drawable.animation2);
        AnimationDrawable animationDrawable = (AnimationDrawable) mRotateView
                .getDrawable();
        ...
        if (currentPos < mOffsetToRefresh && lastPos >= mOffsetToRefresh) {
            if (isUnderTouch && status == PtrFrameLayout.PTR_STATUS_PREPARE) {
                ...
                if (mRotateView != null) {
                    ...
                    mRotateView.setImageResource(R.drawable.refurbish_2);
                }
            }
            ...
            if (isUnderTouch && status == PtrFrameLayout.PTR_STATUS_PREPARE) {
                ...
                if (mRotateView != null) {
                   ...
                   // mRotateView.startAnimation(mFlipAnimation);
                    mRotateView.setImageResource(R.drawable.refurbish_1);
                }
            }
        }
    }
